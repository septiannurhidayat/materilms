                ...
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col-lg-6 d-none d-lg-block">
                            <img src="<?php echo e(asset('img/unsiclass.jpg')); ?>"  alt="user-image">
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\LMS_Unsiclass\resources\views/auth/register.blade.php ENDPATH**/ ?>