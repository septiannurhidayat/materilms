...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1>Tambah Materi</h1>
            <form method="POST" action="<?php echo e(route('materi.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\LMS_Unsiclass\resources\views/materi/create.blade.php ENDPATH**/ ?>